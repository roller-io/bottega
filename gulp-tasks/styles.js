...
function compileSassAutoprefix(genSourceMaps, minify) {
  ...
  return gulp.src([
      ...
      '!' + GLOBAL.bottega.src.styles + '/**/_*.scss',
      GLOBAL.bottega.src.styles + '/**/*.scss',
      '!' + GLOBAL.bottega.src.docs + '/**/*.scss',
      GLOBAL.bottega.src.docs + '/**/_*.scss'
    ])
...
gulp.task('compile-dev-css', function() {
  return compileSassAutoprefix(true, false)
    ...
    .pipe(gulp.dest(GLOBAL.bottega.build.styles))
